  ...
  Sorting::StdSort)
{
  ...
  SECTION("single element") { REQUIRE(algo.run({ 42 }) == std::vector<int>{ 42 }); }
  ...
  SECTION("two elements swapped") { REQUIRE(algo.run({ 2, 1 }) == std::vector<int>{ 1, 2 }); }
}
...
TEST_CASE("Sorting benchmarks", "[sorting][benchmark][!benchmark]")
{
  ...
  BENCHMARK("QuickSort  random-100") { return Sorting::QuickSort{}.run(r100); };
  BENCHMARK("MergeSort  random-100") { return Sorting::MergeSort{}.run(r100); };
  BENCHMARK("HeapSort   random-100") { return Sorting::HeapSort{}.run(r100); };
  BENCHMARK("std::sort  random-100") { return Sorting::StdSort{}.run(r100); };
  ...
  BENCHMARK("HeapSort   random-1k") { return Sorting::HeapSort{}.run(r1k); };
  BENCHMARK("std::sort  random-1k") { return Sorting::StdSort{}.run(r1k); };

  BENCHMARK("QuickSort  random-10k") { return Sorting::QuickSort{}.run(r10k); };
  BENCHMARK("std::sort  random-10k") { return Sorting::StdSort{}.run(r10k); };

  BENCHMARK("QuickSort  sorted-1k") { return Sorting::QuickSort{}.run(s1k); };
  BENCHMARK("HeapSort   sorted-1k") { return Sorting::HeapSort{}.run(s1k); };
  BENCHMARK("std::sort  sorted-1k") { return Sorting::StdSort{}.run(s1k); };

  BENCHMARK("QuickSort  reversed-1k") { return Sorting::QuickSort{}.run(rev1k); };
  BENCHMARK("HeapSort   reversed-1k") { return Sorting::HeapSort{}.run(rev1k); };
}